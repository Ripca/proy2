...
<head>
    ...
    <title>Gestión de Marcas - Sistema Empresa</title>
...
<body class="bg-light">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">Comience agregando una nueva marca</p>
                            <a href="MarcaServlet?action=new" class="btn btn-primary">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Está seguro que desea eliminar la marca <strong id="marcaNombre"></strong>?</p>
    ...
    <script>
        function confirmarEliminacion(id, nombre) {
            document.getElementById('marcaNombre').textContent = nombre;
            document.getElementById('confirmarEliminar').href = 'MarcaServlet?action=delete&id=' + id;
